...
-- AddForeignKey
ALTER TABLE `QuestionEntity` ADD CONSTRAINT `QuestionEntity_categoryColumn_fkey` FOREIGN KEY (`categoryColumn`) REFERENCES `CategoryEntity`(`column`) ON DELETE CASCADE ON UPDATE CASCADE;
